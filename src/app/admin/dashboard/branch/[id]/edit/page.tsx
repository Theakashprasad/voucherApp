        ...
        <div className="mx-auto w-full max-w-5xl">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-600">
              Update branch details and voucher information
            </p>
          </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-lg p-6 space-y-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Update the basic branch details
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-lg p-6 space-y-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Manage voucher books for this branch
                    </p>
                  </div>
                </div>
                            ...
                            <ConfirmDialog
                              triggerLabel={
                                isDeleting === index ? (
                                  ...
                                  <div className="p-1 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors duration-200 cursor-pointer">
                                    <X className="w-4 h-4" />
                                  </div>
                                )
                              }
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 px-4 rounded-lg font-medium hover:shadow-md hover:scale-105 focus:ring-4 focus:ring-green-100 transition-all duration-200 text-base"
                >
                  Save Changes
                </button>
              </div>
